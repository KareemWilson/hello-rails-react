...
**Hello Rails React** is a rails API which generates a random greetings by viewing react components
...
- Backend Api to provide random greetings by viewing react components
...
```sh
  cd newfolder
  git clone git@github.com:KareemWilson/hello-rails-backend.git
```
